-- Banco de Chile: Cargo en Cuenta (compra débito CC, distinto de bancochile_tc)
...
alter table email_movements add constraint email_movements_source_check
  check (source in (
    'bancochile_tc', 'bancochile_cargo_cuenta', 'bancochile_pago', 'bancochile_transfer_out',
...
-- promote: cargo cuenta CC se promueve como gasto (igual que TC / débito BE)
